...
const rootReducer = combineReducers({ // 1.adım : birden fazla olan reducerları combineReducer ile birleştiriyoruz. sonrasında const ile bir isim vererek değişkene aktarıyoruz.
    userReducer,
    todoReducer, } )
...
// PROJEYE TANITIRKEN 
// main.jsx dosyasında bulunan app.jsx dosyasını sarmalamamız gerekir. bunu yaparken de PROVİDER kullanıyoruz.