        ...
        <div className="modal-dialog w-75 h-50">
            <div className="modal-content">
                ...
                <div className="modal-body my-2">
                    ...
                    <input ref={inputRef} defaultValue={todo.text} type="text" className="form-control shadow mt-2" />
                </div>
                <div className="modal-footer">
                    <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={close}> İptal Et </button>
